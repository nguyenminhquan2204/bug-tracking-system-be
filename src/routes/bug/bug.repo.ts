...
import { BugType, CreateBugBodyType, GetBugsQueryBodyType, GetBugsResType, UpdateBugBodyType } from './bug.model';
...
export class BugRepo {
   ...
   async changeStatus(bugId: number, status: BugStatus): Promise<BugType | NotFoundException> {
